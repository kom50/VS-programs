...
public class Library extends JFrame implements ActionListener {
	...
	// Panel mainPage;
	private JButton bookPageOpen, studentPageOpen, bookIssuePageOpen, bookReturnPageOpen, exitButton;
	// for all page
	private JPanel centerPanel, leftSidePanel, rightSidePanel, rightSideComponentPanel;
	// For book management page
	private JButton addButton, showButton, deleteButton, searchButton, updateButton, backButton;
	//
	private Font f1;
	// For change color of button
	private JButton prev = new JButton(); // color
	// Issue book Components
	private JButton addIssueBookButton, showIssueBookButton;
	// For reset button
	private int pageNo = 0;
	// issue book form componenets
	private JButton submitIssuedButton;
	private JLabel issuedDateLabel;
	private JTextField issuedDateField;
	// Return book form componenets
	private JLabel returnDateLabel;
	private JTextField returnDateField;
	private JButton submitReturnButton;

	// Student management page componenets
	private JButton addSButton;
	private JButton showSButton;
	private JButton deleteSButton;
	private JButton searchSButton;
	private JButton updateSButton;

	// student page components
	private JLabel sRollNoLabel;
	private JLabel sNameLabel;
	private JLabel sClassLabel;
	private JLabel sGenderLabel;
	private JLabel sAddressLabel;
	private JLabel sMobileNoLabel;

	private JTextField sRollNoField;
	private JTextField sNameField;
	private JTextField sClassField;
	// private JTextField sGenderField;
	private JTextField sAddressField;
	private JTextField sMobileNoField;
	private JButton submitSButtonAdd;
	...
	private void issueBookDetails() {
		...
		addIssueBookButton.setBackground(Color.white);
		showIssueBookButton.setBackground(Color.white);
		backButton.setBackground(Color.white);

		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 2;
		gb.gridx = 0;
		leftSidePanel.add(new JSeparator(), gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 3;
		gb.gridx = 0;
		leftSidePanel.add(addIssueBookButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 0;
		leftSidePanel.add(showIssueBookButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 5;
		gb.gridx = 0;
		leftSidePanel.add(backButton, gb);

		addIssueBookButton.setFont(f1);
		showIssueBookButton.setFont(f1);
		backButton.setFont(f1);
		leftSidePanel.setFont(f1);
		addIssueBookButton.addActionListener(this);
		showIssueBookButton.addActionListener(this);
	...
	String currentDate() {
		...
		String date = (c1.get(Calendar.DATE) < 10 ? "0" + c1.get(Calendar.DATE) : "" + c1.get(Calendar.DATE)) + "-"
				+ month[c1.get(Calendar.MONTH) - 1] + "-" + c1.get(Calendar.YEAR);
	...
	private void addIssueBookDetailsForm() {
		...
		sRollNoLabel = new JLabel("Student Roll No.* : ");
		...
		submitIssuedButton.setBackground(Color.white);

		sRollNoLabel.setFont(f1);
		sNameLabel.setFont(f1);
		bookIdLabel.setFont(f1);
		bookTitleLabel.setFont(f1);
		issuedDateLabel.setFont(f1);
		sRollNoField.setFont(f1);
		sNameField.setFont(f1);
		bookIdField.setFont(f1);
		bookTitleField.setFont(f1);
		issuedDateField.setFont(f1);
		...
		sRollNoLabel.setForeground(Color.white);
		sNameLabel.setForeground(Color.white);
		bookIdLabel.setForeground(Color.white);
		bookTitleLabel.setForeground(Color.white);
		issuedDateLabel.setForeground(Color.white);
		dateStyle.setForeground(Color.white);

		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 0;
		gb.gridx = 0;
		rightSideComponentPanel.add(bookIdLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 1;
		gb.gridx = 0;
		rightSideComponentPanel.add(bookTitleLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 2;
		gb.gridx = 0;
		rightSideComponentPanel.add(sRollNoLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 3;
		gb.gridx = 0;
		rightSideComponentPanel.add(sNameLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 0;
		rightSideComponentPanel.add(issuedDateLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		...
		gb.gridy = 0;
		gb.gridx = 1;
		rightSideComponentPanel.add(bookIdField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 1;
		gb.gridx = 1;
		rightSideComponentPanel.add(bookTitleField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 2;
		gb.gridx = 1;
		rightSideComponentPanel.add(sRollNoField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 3;
		gb.gridx = 1;
		rightSideComponentPanel.add(sNameField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 1;
		rightSideComponentPanel.add(issuedDateField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 5;
		gb.gridx = 0;
		gb.gridwidth = 2;
		rightSideComponentPanel.add(new JSeparator(), gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 6;
		gb.gridx = 0;
		gb.gridwidth = 1;
		rightSideComponentPanel.add(resetButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 6;
		gb.gridx = 1;
		rightSideComponentPanel.add(submitIssuedButton, gb);

		resetButton.addActionListener(this);
		submitIssuedButton.addActionListener(this);
	...
	private void showIssueBookDetailsForm() {
		...
		try {
			String q1 = "select *from " + studentTableName + ", " + bookTableName + ", " + issueTableName + " where "
					+ issueTableName + ".bookid = " + bookTableName + ".bookid and " + issueTableName + ".rollno = "
					+ studentTableName + ".rollno";
		...
		String heading[] = { "Roll No.", "Student Name", "Mobile No.", "Book Id", "Book Title", "issued Date",
				"Total Books" };

		rightSideComponentPanel.add(createTable(heading, data)); // add table on showBookFrom panel
		rightSidePanel.add(rightSideComponentPanel, BorderLayout.CENTER);
	}
	...
	private JButton showReturnBookButton;
	...
	private void returnBookDetails() {
		...
		addReturnBookButton.setBackground(Color.white);
		showReturnBookButton.setBackground(Color.white);
		backButton.setBackground(Color.white);
		...
		gb.gridy = 2;
		gb.gridx = 0;
		leftSidePanel.add(addReturnBookButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 3;
		gb.gridx = 0;
		leftSidePanel.add(showReturnBookButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 0;
		leftSidePanel.add(backButton, gb);

		addReturnBookButton.setFont(f1);
		showReturnBookButton.setFont(f1);
		backButton.setFont(f1);
		leftSidePanel.setPreferredSize(new Dimension(400, 100));
		addReturnBookButton.setPreferredSize(new Dimension(350, 35));
		addReturnBookButton.addActionListener(this);
		showReturnBookButton.addActionListener(this);
		backButton.addActionListener(this);
	}
	...
	private void addReturnBookDetailsForm() {
		...
		sNameField.setEnabled(false);
		bookTitleField.setEnabled(false);
		sRollNoField.setEnabled(false);
		issuedDateField.setEnabled(false);
		returnDateField.setEnabled(false);
		returnDateField.setText(currentDate());
		JLabel dateStyle = new JLabel("Ex. : 01-Jan-2020");
		...
		bookIdField.setFont(f1);
		bookTitleField.setFont(f1);
		returnDateField.setFont(f1);
		issuedDateField.setFont(f1);
		resetButton.setFont(f1);
		submitReturnButton.setFont(f1);
		...
		issuedDateLabel.setForeground(Color.white);
		dateStyle.setForeground(Color.white);
		submitReturnButton.setBackground(Color.white);
		resetButton.setBackground(Color.white);
		...
		gb.gridy = 5;
		gb.gridx = 0;
		rightSideComponentPanel.add(returnDateLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 5;
		gb.gridx = 2;
		rightSideComponentPanel.add(dateStyle, gb);
		...
		gb.gridy = 5;
		gb.gridx = 1;
		rightSideComponentPanel.add(returnDateField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 6;
		gb.gridx = 0;
		gb.gridwidth = 2;
		...
		gb.gridy = 7;
		gb.gridx = 1;
		rightSideComponentPanel.add(submitReturnButton, gb);

		resetButton.addActionListener(this);
		submitReturnButton.addActionListener(this);
		bookIdField.addKeyListener(new CheckNumber());
	}
	...
	JComponent createTable(String[] heading, String[][] data) {
	...
	private void studentManagementDetails() {
		...
		addSButton.setBackground(Color.white);
		showSButton.setBackground(Color.white);
		deleteSButton.setBackground(Color.white);
		searchSButton.setBackground(Color.white);
		updateSButton.setBackground(Color.white);
		backButton.setBackground(Color.white);
		...
		leftSidePanel.setFont(f1);
		addSButton.setFont(f1);
		showSButton.setFont(f1);
		deleteSButton.setFont(f1);
		searchSButton.setFont(f1);
		updateSButton.setFont(f1);
		backButton.setFont(f1);
		...
		gb.gridy = 2;
		gb.gridx = 0;
		leftSidePanel.add(addSButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 0;
		leftSidePanel.add(deleteSButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 3;
		gb.gridx = 0;
		leftSidePanel.add(showSButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 5;
		gb.gridx = 0;
		leftSidePanel.add(searchSButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 6;
		gb.gridx = 0;
		leftSidePanel.add(updateSButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 7;
		gb.gridx = 0;
		leftSidePanel.add(backButton, gb);
		...
		showSButton.addActionListener(this);
		deleteSButton.addActionListener(this);
		searchSButton.addActionListener(this);
	...
	private void addStudentDetailsForm() {
		...
		sGenderLabel = new JLabel("Gender* : ");
		sAddressLabel = new JLabel("Address* : ");
		sMobileNoLabel = new JLabel("Mobile No.* : ");

		bg = new ButtonGroup();
		ml = new JRadioButton("A) Male", true);
		fml = new JRadioButton("B) Female", false);
		bg.add(ml);
		bg.add(fml);
		...
		// sGenderField = new JTextField();
		sAddressField = new JTextField();
		sMobileNoField = new JTextField();
		resetButton = new JButton("Reset");
		submitSButtonAdd = new JButton("Add Record");
		...
		sRollNoLabel.setFont(f1);
		sNameLabel.setFont(f1);
		sClassLabel.setFont(f1);
		sGenderLabel.setFont(f1);
		sAddressLabel.setFont(f1);
		sMobileNoLabel.setFont(f1);
		sRollNoField.setFont(f1);
		sNameField.setFont(f1);
		sClassField.setFont(f1);
		ml.setFont(f1);
		fml.setFont(f1);
		sAddressField.setFont(f1);
		sMobileNoField.setFont(f1);
		resetButton.setFont(f1);
		submitSButtonAdd.setFont(f1);

		sRollNoLabel.setForeground(Color.white);
		sNameLabel.setForeground(Color.white);
		sClassLabel.setForeground(Color.white);
		sGenderLabel.setForeground(Color.white);
		sAddressLabel.setForeground(Color.white);
		sMobileNoLabel.setForeground(Color.white);
		resetButton.setBackground(Color.white);
		submitSButtonAdd.setBackground(Color.white);
		...
		gb.gridy = 2;
		gb.gridx = 0;
		rightSideComponentPanel.add(sClassLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 3;
		gb.gridx = 0;
		rightSideComponentPanel.add(sGenderLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 0;
		rightSideComponentPanel.add(sAddressLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 5;
		gb.gridx = 0;
		rightSideComponentPanel.add(sMobileNoLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 0;
		gb.gridx = 1;
		rightSideComponentPanel.add(sRollNoField, gb);
		...
		gb.gridy = 2;
		gb.gridx = 1;
		rightSideComponentPanel.add(sClassField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 3;
		gb.gridx = 1;
		rightSideComponentPanel.add(genderPanel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 1;
		rightSideComponentPanel.add(sAddressField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 5;
		gb.gridx = 1;
		rightSideComponentPanel.add(sMobileNoField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 6;
		gb.gridx = 0;
		gb.gridwidth = 2;
		...
		gb.gridy = 7;
		gb.gridx = 1;
		rightSideComponentPanel.add(submitSButtonAdd, gb);

		resetButton.addActionListener(this);
		submitSButtonAdd.addActionListener(this);
		sRollNoField.addKeyListener(new CheckNumber());
		sMobileNoField.addKeyListener(new CheckNumber());
	}

	private boolean flagK; // for check a entered data is number or not
	private boolean flagR; //
	private int totalBooks; // holds total number of books
					...
					if (pageNo == 10) {
						...
						try {
							ResultSet rs = smt.executeQuery(
									"select name, totalbook from " + studentTableName + " where rollno = " + text);
							if (rs.next()) {
								sNameField.setText(rs.getString("name"));
								totalBooks = rs.getInt("totalbook");
								System.out.println(" IS found  " + rs.getString("name") + " Total books issue "
										+ rs.getInt("totalbook"));
								if (totalBooks >= 3) {
			...
			if (pageNo == 10) {
				if (keyObj == bookIdField) {
					...
					try {
						...
						ResultSet rs = smt.executeQuery(
								"select booktitle , bookissue from " + bookTableName + " where bookid = " + text);
						if (rs.next()) {
							System.out.println(
									"Book iS found  " + rs.getString("booktitle") + "  " + rs.getString("bookissue"));
			...
			if (pageNo == 11) {
				if (keyObj == bookIdField) {
					...
					try {
						...
						System.out.println("Book id is " + text);
						ResultSet rs = smt.executeQuery(
								"select rollno, issuedate from " + issueTableName + " where bookid = " + text);
						if (rs.next()) {
	...
	private void showStudentDetailsForm() {
		...
		try {
			...
			// String total="SELECT COUNT(*) FROM student ORDER BY rollno ASC"; // for count
			// rows in table
			ResultSet rs = smt.executeQuery(q1);
			if (rs.next()) {
				int i = 0;
				do {
					// System.out.println( rs.getString(2)+"\t\t" + rs.getInt("rollno")+"\t"+
					// rs.getString(3));
					data[i][0] = Integer.toString(rs.getInt("rollno"));
					data[i][1] = rs.getString("Name");
					data[i][2] = rs.getString("class");
	...
	private JButton submitSButtonDelete;
	...
	private void deleteStudentDetailsForm() {
		...
		sRollNoField.setFont(f1);
		sNameField.setFont(f1);
		submitSButtonDelete.setFont(f1);
		...
		gb.gridy = 3;
		gb.gridx = 0;
		rightSideComponentPanel.add(submitSButtonDelete, gb);
	...
	private JButton submitSButtonSearch;
	...
	private void searchStudentDetailsForm() {
		...
		sRollNoField.setFont(f1);
		sNameField.setFont(f1);
		submitSButtonSearch.setFont(f1);
		sRollNoLabel.setForeground(Color.white);
		sNameLabel.setForeground(Color.white);
		sAddressLabel.setForeground(Color.white);
		...
		gb.gridy = 0;
		gb.gridx = 0;
		right1.add(sRollNoLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 1;
		gb.gridx = 0;
		right1.add(sNameLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 0;
		gb.gridx = 1;
		right1.add(sRollNoField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 2;
		gb.gridx = 0;
		right1.add(sAddressLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 1;
		gb.gridx = 1;
		right1.add(sNameField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 2;
		gb.gridx = 1;
		right1.add(sAddressField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 3;
		gb.gridx = 0;
		gb.gridwidth = 2;
		right1.add(new JSeparator(), gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 0;
		right1.add(submitSButtonSearch, gb);
		submitSButtonSearch.addActionListener(this);
	}

	private JButton submitSButtonUpdate;
	private int updateCheckbox;
	...
	private void updateStudentDetailsForm() {
		...
		sRollNoLabel.setFont(f1);
		sRollNoField.setFont(f1);
		submitSButtonUpdate.setFont(f1);
		l1.setFont(f1);
		cBox1.setFont(f1);
		cBox2.setFont(f1);
		cBox3.setFont(f1);
		...
		gb.gridy = 1;
		gb.gridx = 1;
		rightSideComponentPanel.add(l1, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 1;
		gb.gridx = 2;
		rightSideComponentPanel.add(box, gb);
		...
		gb.gridy = 6;
		gb.gridx = 1;
		rightSideComponentPanel.add(submitSButtonUpdate, gb);
		...
		sRollNoField.addKeyListener(new KeyAdapter() {
			public void keyReleased(KeyEvent ke) {
				...
				try {
					ResultSet rs = smt
							.executeQuery("select rollno from " + studentTableName + " where rollno = " + rollno);
					while (rs.next()) {
						flagUpdate = true;
	...
	private void bookManagementDetails() {
		...
		gb.gridy = 2;
		gb.gridx = 0;
		leftSidePanel.add(addButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 0;
		leftSidePanel.add(deleteButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 3;
		gb.gridx = 0;
		leftSidePanel.add(showButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 5;
		gb.gridx = 0;
		leftSidePanel.add(searchButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 6;
		gb.gridx = 0;
		leftSidePanel.add(updateButton, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 7;
		gb.gridx = 0;
		leftSidePanel.add(backButton, gb);
	...
	// Panel addBookForm;
	private JLabel bookIdLabel, bookNameLabel, bookTitleLabel, bookAuthorLabel;
	private JTextField bookIdField, bookNameField, bookTitleField, bookAuthorField;
	private JButton resetButton, submitButtonAdd;
	...
	private void errorMessage(String errorMsg) {
		...
		// errormsgLabel.setBorder(new CompoundBorder(new LineBorder(Color.WHITE), new
	...
	private void addBookDetailsForm() {
		...
		bookTitleLabel.setFont(f1);
		bookAuthorLabel.setFont(f1);
		bookIdField.setFont(f1);
		bookNameField.setFont(f1);
		bookTitleField.setFont(f1);
		bookAuthorField.setFont(f1);
		resetButton.setFont(f1);
		submitButtonAdd.setFont(f1);
		...
		resetButton.setBackground(Color.WHITE);
		submitButtonAdd.setBackground(Color.WHITE);
		...
		gb.gridy = 1;
		gb.gridx = 0;
		rightSideComponentPanel.add(bookNameLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 2;
		gb.gridx = 0;
		rightSideComponentPanel.add(bookTitleLabel, gb);
		...
		gb.gridy = 3;
		gb.gridx = 0;
		rightSideComponentPanel.add(bookAuthorLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 0;
		gb.gridx = 1;
		rightSideComponentPanel.add(bookIdField, gb);
		...
		gb.gridy = 1;
		gb.gridx = 1;
		rightSideComponentPanel.add(bookNameField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 2;
		gb.gridx = 1;
		rightSideComponentPanel.add(bookTitleField, gb);
		...
		gb.gridy = 3;
		gb.gridx = 1;
		rightSideComponentPanel.add(bookAuthorField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 0;
		gb.gridwidth = 2;
		...
		gb.gridy = 5;
		gb.gridx = 1;
		rightSideComponentPanel.add(submitButtonAdd, gb);

		resetButton.addActionListener(this);
		submitButtonAdd.addActionListener(this);
	...
	private JButton submitButtonDelete;
	...
	private void deleteBookDetailsForm() {
		...
		gb.gridy = 3;
		gb.gridx = 0;
		rightSideComponentPanel.add(submitButtonDelete, gb);
		submitButtonDelete.addActionListener(this);
		rightSidePanel.add(rightSideComponentPanel, BorderLayout.CENTER);
	}

	private JButton submitButtonSearch;
	...
	private void searchBookDetailsForm() {
		...
		bookAuthorField.setFont(f1);
		bookAuthorLabel.setFont(f1);
		submitButtonSearch.setFont(f1);
		resetButton.setFont(f1);

		bookIdLabel.setForeground(Color.white);
		bookNameLabel.setForeground(Color.white);
		bookAuthorLabel.setForeground(Color.white);
		submitButtonSearch.setBackground(Color.WHITE);
		resetButton.setBackground(Color.WHITE);
		...
		gb.gridy = 0;
		gb.gridx = 0;
		right1.add(bookIdLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 1;
		gb.gridx = 0;
		right1.add(bookNameLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 0;
		gb.gridx = 1;
		right1.add(bookIdField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 1;
		gb.gridx = 1;
		right1.add(bookNameField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 2;
		gb.gridx = 0;
		right1.add(bookAuthorLabel, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 2;
		gb.gridx = 1;
		right1.add(bookAuthorField, gb);
		gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 3;
		gb.gridx = 0;
		gb.gridwidth = 2;
		...
		gb.gridx = 0;
		gb.gridwidth = 1;
		right1.add(resetButton, gb);
		// gb.fill = GridBagConstraints.HORIZONTAL;
		gb.gridy = 4;
		gb.gridx = 1;
		right1.add(submitButtonSearch, gb);
	...
	private JButton submitButtonUpdate;
	...
	private void updateBookDetailsForm() {
		...
		gb.gridy = 1;
		gb.gridx = 2;
		rightSideComponentPanel.add(boxPanel, gb);
		...
		gb.gridy = 6;
		gb.gridx = 2;
		rightSideComponentPanel.add(submitButtonUpdate, gb);
		rightSidePanel.add(rightSideComponentPanel, BorderLayout.CENTER);

		submitButtonUpdate.addActionListener(this);
		resetButton.addActionListener(this);
		cBox1.addItemListener(new ItemEvent1());
		cBox2.addItemListener(new ItemEvent1());
		cBox3.addItemListener(new ItemEvent1());
	...
	public Library() {
		...
		add(right, BorderLayout.WEST);/*
										 * left.setBackground(Color.RED); right.setBackground(Color.RED);
										 */
	...
	private JButton sem1, sem2, sem3, sem4, sem5, sem6;
	...
	public void classPage() {
		...
		gbc1.gridy = 0;
		gbc1.gridx = 0;
		leftPanel.add(sem1, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 1;
		gbc1.gridx = 0;
		leftPanel.add(sem2, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 2;
		gbc1.gridx = 0;
		leftPanel.add(sem3, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 3;
		gbc1.gridx = 0;
		leftPanel.add(sem4, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 4;
		gbc1.gridx = 0;
		leftPanel.add(sem5, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 5;
		gbc1.gridx = 0;
		leftPanel.add(sem6, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 6;
		gbc1.gridx = 0;
		leftPanel.add(exitButton, gbc1);
	...
	public void openMainPage() {
		...
		bookPageOpen.setBackground(Color.white);
		studentPageOpen.setBackground(Color.white);
		bookIssuePageOpen.setBackground(Color.white);
		bookReturnPageOpen.setBackground(Color.white);
		backButton.setBackground(Color.white);

		leftPanel.setFont(f1);
		bookReturnPageOpen.setFont(f1);
		backButton.setFont(f1);
		bookPageOpen.setFont(f1);
		studentPageOpen.setFont(f1);
		bookIssuePageOpen.setFont(f1);
		...
		gbc1.gridy = 0;
		gbc1.gridx = 0;
		leftPanel.add(sem, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 1;
		gbc1.gridx = 0;
		leftPanel.add(new JSeparator(), gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 3;
		gbc1.gridx = 0;
		leftPanel.add(bookPageOpen, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 4;
		gbc1.gridx = 0;
		leftPanel.add(studentPageOpen, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 5;
		gbc1.gridx = 0;
		leftPanel.add(bookIssuePageOpen, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 6;
		gbc1.gridx = 0;
		leftPanel.add(bookReturnPageOpen, gbc1);
		gbc1.fill = GridBagConstraints.VERTICAL;
		gbc1.gridy = 7;
		gbc1.gridx = 0;
		leftPanel.add(backButton, gbc1);

		bookPageOpen.addActionListener(this);
		studentPageOpen.addActionListener(this);
		bookIssuePageOpen.addActionListener(this);
		bookReturnPageOpen.addActionListener(this);
		backButton.addActionListener(this);
	...
	private String bookTableName, studentTableName, issueTableName, returnTableName, semesterName;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == login) {
			...
			if (user.equals("system") == true && pass.equals("12345") == true) {
				...
				JOptionPane.showMessageDialog(this, "Please fill all fields.", "Error message",
						JOptionPane.ERROR_MESSAGE);
			} else if (user.equals("")) {
				JOptionPane.showMessageDialog(this, "Please fill user name fields.", "Error message",
						JOptionPane.ERROR_MESSAGE);
			} else if (pass.equals("")) {
				JOptionPane.showMessageDialog(this, "Please fill password fields.", "Error message",
						JOptionPane.ERROR_MESSAGE);
			} else if (user.equals("system") != true && pass.equals("12345") != true) {
				JOptionPane.showMessageDialog(this, "Wrong user name and password.", "Error message",
						JOptionPane.ERROR_MESSAGE);
		...
		if (obj == submitButtonAdd) {
			...
			String q3 = "insert into " + bookTableName + " values(" + id + ",'" + bname + "','" + btitle + "'" + ",'"
					+ bauthor + "', 'NO')";
			...
			if (id.equals("") || bname.equals("") || bauthor.equals("") || btitle.equals("")) {
				...
				int op = JOptionPane.showConfirmDialog(this, "Are You Sure?", "Message", JOptionPane.YES_NO_OPTION,
		...
		if (obj == submitButtonSearch) {
			...
			if (flag == true) {
				...
				rightSideComponentPanel.add(createTable(heading, data), BorderLayout.CENTER);
			}
		}
		if (obj == updateButton) {
		...
		if (obj == submitSButtonAdd) {
			if (flagK == true) {
				...
				String q3 = "insert into " + studentTableName + " values(" + rollno + ",'" + name + "', '"
						+ semesterName + "','" + gender + "', '" + address + "', '" + mobileno + "', 0)";
				System.out.println("insert values is : " + q3);
		...
		if (obj == submitSButtonSearch) {
			...
			if (flag == true) {
				...
				String heading[] = { "Roll No.", "Name", "Class", "Gender", "Address", "Mobile No.", "Total Books" };
				rightSideComponentPanel.add(createTable(heading, data));
			}
		}
			...
			if (rollno.equals("") || bookid.equals("") || date.equals(""))
				...
				if (flagK == true && flagR == true && totalBooks < 3) {
					...
					try {
						int m = smt.executeUpdate(q3);
						smt.executeUpdate(
								"update " + bookTableName + " set bookissue = 'YES' where bookid = " + bookid);
						smt.executeUpdate("update " + studentTableName
								+ " set totalbook = totalbook + 1 where rollno = " + rollno);
						if (m == 1) {
							errormsgLabel.setText("Data is inserted");
							ResultSet rs = smt.executeQuery(
									"select totalbook from " + studentTableName + " where rollno = " + rollno);
							if (rs.next())
								totalBooks = rs.getInt("totalBook");
						} else {
							errormsgLabel.setText("Data is not inserted");
		...
		if (obj == submitReturnButton) {
			...
			if (bookid.equals("") || date.equals(""))
				...
				String month = " ";
				String monthStr[] = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov",
						"Dec" };
				month = monthStr[m1 - 1];
				dateis = String.join("-", day, month, year);
				String q3 = "insert into " + returnTableName + " values(" + bookid + ", '" + booktitle + "', " + rollno
						+ ", '" + name + "', '" + dateis + "', '" + date + "')";
				try {
					int m = smt.executeUpdate(q3);
					smt.executeUpdate("update " + bookTableName + " set bookissue = 'NO' where bookid = " + bookid);
					smt.executeUpdate(
							"update " + studentTableName + " set totalbook = totalbook - 1 where rollno = " + rollno);
		...
		// for Exit
		if (obj == exitButton) {
			int exit = JOptionPane.showConfirmDialog(this, "Do you want to Exit?", "Exit Message",
	...
	class WindowClose extends WindowAdapter {
		public void windowClosing(WindowEvent we) {
			...
			/*
			 * int exit = JOptionPane.showConfirmDialog(LibraryNew.this,
			 * "Do you want to Exit?", "Exit", JOptionPane.YES_NO_OPTION,
			 * JOptionPane.QUESTION_MESSAGE); if(exit == 0) { obj1.dispose(); }
			 */
			System.exit(0);
		}
	}
...
// Numbers of line 2454 // 01-02-2021 Updated some bugs